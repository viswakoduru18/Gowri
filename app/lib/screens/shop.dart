    ...
    return RefreshIndicator(
      ...
      child: CustomScrollView(
        slivers: [
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          isCollapsed: true,
                          hintText: 'Search products, concerns, SKUs',
          ...
          // Category chips only help once Zoho items carry more than one category.
          if (s.categories.length > 2 || s.cat != 'All')
            SliverToBoxAdapter(
              child: SizedBox(
                height: 50,
          ...
          if (s.products.isEmpty)
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Text(
                  'Nothing matched. Try "magnesium" or "glow".',
                  textAlign: TextAlign.center,
                  style: outfit(14, color: G.muted),
                ),
              ),
            )
          else
            SliverPadding(
              ...
              sliver: SliverGrid.builder(
                ...
                itemBuilder: (_, i) => Rise(key: ValueKey('${s.cat}|${items[i].sku}'), child: ProductCard(items[i], showWish: true)),
              ),
            ),
        ],
      ),
